...
class Spectrum  :
    ...
    def Cut_n_Estimate_Spectrum(self, cut = True, estimate = False, cols = cols_mark,distanza = 2/3, verbose = False ):
        ...
        self.p0  =   pd.DataFrame({}, columns = cols, index = ['Initials'])
    ...
    def Estimate_Initial_Parameters_by_Markov(self, p0, treshold, columns, **kwargs):
